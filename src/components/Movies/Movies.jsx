        ...
        <div className="card=container">
            <div className="card">
                <div className="card-body">
                    ...
                    <img src={jawan} 
                    alt ="jawan" className="card-media" />
                    <img src={OMG2} 
                    alt ="omg2" className="card-media" />
                          <img src={encanto} 
                    alt ="encanto" className="card-media" />
                          <img src={ind} 
                    alt ="ind" className="card-media" />
                          <img src={luca} 
                    alt ="luca" className="card-media" />
                          <img src={tanhaji} 
                    alt ="tanhaji" className="card-media" />
                          <img src={singham} 
                    alt ="singham" className="card-media" />
                </div>
            </div>
        </div>
        </>
